  ...
  return <section className="relative pt-28 pb-20 overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          <h1 className="font-bold leading-tight mb-6 bg-clip-text text-transparent bg-gradient-to-r from-edu-dark via-edu-primary to-edu-secondary animate-slideUp">Transform Learning Experiences with PRADANA KONTOL</h1>
